...
if(isset($_POST['CustomerMsisdn']) && isset($_POST['Amount']) && isset($_POST['Product']) && isset($_POST['RefNo'])) 
{
	...
	$response_value   = $transaction_Obj->sendRequest($unique_value, $msisdn, 0.02, $item, trim($unique_value));//23327750573 6233577665092
	...
	// $success = 0;
	// $success = $data_handler_Obj->save_transaction_initiate_response($unique_value, $transactionID, $correlationID, $status, $code, $description, $paymentId, $paymentReference);
